...
$latestNews = $db->fetchAll("SELECT * FROM news WHERE status = 'published' ORDER BY created_at DESC LIMIT 3");
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            foreach ($latestNews as $news): 
                ...
                $link = BASE_URL . "/noticia/" . $news['slug']; 
                $img = !empty($news['image_path']) ? $news['image_path'] : 'assets/img/news/08.jpg';
                
                // --- 2. TRADUCCIÓN DINÁMICA (Aquí ocurre la magia de la API) ---
                $titulo_noticia = $news['title'];
                
                // Si el idioma NO es español, le pedimos a la API que traduzca el título
            ...
            <div class="col-xl-4 col-md-6 col-lg-6 wow fadeInUp d-flex align-items-stretch" data-wow-delay=".<?php echo $delay; ?>s">
                <div class="news-card-items-3 style-4 h-100 d-flex flex-column" style="width: 100%;">
                    <div class="news-image">
                        <img src="<?php echo $img; ?>" alt="<?php echo htmlspecialchars($titulo_noticia); ?>" style="height: 280px; object-fit: cover; width: 100%;">
                    </div>
        ...
        <div class="text-center mt-5 wow fadeInUp" data-wow-delay=".9s">
            <a href="<?php echo BASE_URL; ?>/noticias" class="theme-btn">
